...
class db_report extends report {
	...
	public function getEvents($item, $filter)
	{
		$query = "SELECT service,host,description, COUNT(*) AS n_events FROM $this->table $filter GROUP BY host, description ORDER BY n_events DESC";
